        ...
        <View style={[styles.container,{backgroundColor:'#90b0b5'}]}>
            ...
            >
                <LinearGradient colors={['#4b937c', '#709c97', '#90b0b5']} style={styles.linearGradient}>
                    ...
                    <TouchableHighlight style={buttons.login} onPress={()=>navigation.navigate('Home')}>
                        <Text style={buttons.text}>Login</Text>
                    </TouchableHighlight>

                    <View style={{flexDirection:'row',marginHorizontal:15,marginVertical:10,alignItems:'center',justifyContent:'space-around'}}>
                    ...
                    {!user.idToken ? 
                            ...
                            /> :
                            <TouchableHighlight style={{backgroundColor:'white',elevation:2,margin:10,paddingHorizontal:10,paddingVertical:5,borderRadius:5}} onPress={signOut}>
                            <Text>Logout</Text>
                            </TouchableHighlight>
                        }
                        </View>
